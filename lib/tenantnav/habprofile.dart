...
import 'package:p/tenantnav/habprofile2.dart';

class habprofile extends StatefulWidget {
  @override
  _habprofileState createState() => _habprofileState();
}

class _habprofileState extends State<habprofile> {
            ...
            children: [
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => habprofile2()),
                  );
                },
