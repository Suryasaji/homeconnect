...
class habprofile2 extends StatefulWidget {
  @override
  _habprofile2State createState() => _habprofile2State();
}

class _habprofile2State extends State<habprofile2> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => habprofile()),
            );
          },
        ),
      ),
